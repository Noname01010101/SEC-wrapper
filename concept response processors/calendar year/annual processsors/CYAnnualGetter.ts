...
class CYAnnualGetter {
    static getYearAnnualData(conceptResponse, year: string){
    ...
    static #getYearAnnualDataRegular(blocks, year: string){
    ...
    static #getYearAnnualDataInterim(blocks, year: string){
        for (const block of blocks){
